...
const ModalProvider: React.FC<any> = ({ children }) => {
  ...
  return (
    ...
    >
      ...
      `} style={{zIndex: 999, position: 'fixed', left: 0, top: 0, transition: 'opacity ease-in 0.15s'}}>
        <div
          className="absolute top-0 left-0 w-full h-full flex justify-center items-center"
          onClick={handleOverlayDismiss} >
            <div className="w-full h-full backdrop-filter backdrop-blur-sm" style={{backgroundColor: 'rgba(0,0,0,0.5)'}}>
